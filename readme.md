...
- Clone this source.
- Run command ``composer install`` to install all the projects dependencies.
- Make sure you're connected to running MySQL server.
- On your MySQL admin, create a new database named ``vas_recruit``.
- After database created, run comman ``php artisan migrate`` to import all database needed.
- Create a new .env file on this project's root.
