...
@section('title',$title)
@section('content')
<form action="{{route('post.user.add')}}" class="form stacked form-hr" method="POST" id="formAddUser" ajax="true">
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group" >
                                                ...
                                                <input id="emailUser" name="emailUser" class="form-control" type="text" placeholder="Input Email">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label>Password<span class="required-sign">*</span></label>
                                                <input id="passUser" name="passUser" class="form-control" type="password" placeholder="a-z, A-Z, 1-9, 8+ digit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group" >
                                                ...
                                                <input id="firstNameUser" name="firstNameUser" class="form-control" type="text" placeholder="Input first name">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label>Last Name<span class="required-sign">*</span></label>
                                                <input id="lastNameUser" name="lastNameUser" class="form-control" type="text" placeholder="Input last name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex">
                                                    <label class="custome-radio-wrapper mb-0 mr-4"> Male
                                                        <input type="radio" name="genderUser" id="gender1" value="1">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <label class="custome-radio-wrapper mb-0"> Female
                                                        <input type="radio" name="genderUser" id="gender2" value="2">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group" >
                                                ...
                                                <input id="telpUser" name="telpUser" class="form-control" type="text" placeholder="Input telephone number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <div class="form-group" id="roleUserDiv">
                                                ...
                                                <select class="select2 tex-center select2-width" id="roleUser" name="roleUser">
                                                    ...
                                                    <option value="{{$dataRole['id']}}">{{$dataRole['role_name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
