        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="content-email">Congratulations! You have been registered as a candidate for the Astra Daihatsu Career Community. We need some information such as personal data, education, etc. To continue, please login with the username and password that we have provided in this email.</p>
                    <table style="width:100%;margin-bottom:20px;">
                        <tr style="height:40px;">
                            <td class="content-email">Email</td>
                            <td class="value-table">{{$data['email']}}</td>
                        </tr>
                        <tr style="height:40px;">
                            <td class="content-email">Password</td>
