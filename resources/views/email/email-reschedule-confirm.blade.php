        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="content-email">We've already accepted your request for written test/interview reschedule. We'll check our availability for the schedule proposed and our team will confirm to you soon.</p>
                    <hr>
                    <p class="content-email">Thank you</p>
                </div>
                <center>
