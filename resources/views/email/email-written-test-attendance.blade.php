...
<html lang="en">
    ...
    <body style="font-family: 'inter_bold', sans-serif;line-height: 1.6; background:#E8F7EE;">
        ...
        <div class="container">
            <div class="card">
                <center>
                    <img src="https://adm.vasdev.co.id/image/icon/email/icon_written_test_attendence.svg" class="img-title">
                </center>
                ...
                <div class="card-content">
                    ...
                    <img src="https://adm.vasdev.co.id/image/icon/email/icon_appstore.svg" class="img-store">
                    <img src="https://adm.vasdev.co.id/image/icon/email/icon_playstrore.svg" class="img-store">
                    <hr>
