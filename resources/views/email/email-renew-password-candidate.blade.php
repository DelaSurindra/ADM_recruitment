...
<html lang="en">
    ...
    <body style="font-family: 'inter_bold', sans-serif;line-height: 1.6; background:#E8F7EE;">
        ...
        <div class="container">
            <div class="card">
                <center>
                    <img src="https://adm.vasdev.co.id/image/icon/email/icon_renew_password.png" class="img-title">
                </center>
                ...
                <div class="card-content">
                    ...
                    <a href="{{route('get.forget', $data['username'])}}" style="cursor:pointer;"><button class="btn-red">Renew Password</button></a>
                    <a href="{{route('get.forget', $data['username'])}}" style="font-size:10px;">{{url('/').'/'.$data['username']}}</a>
                    <hr>
