        ...
        <form action="{{ route('post.profile.education-information') }}" id="formEditEducationInformation" method="POST" class="form-candidate-view" enctype="multipart/form-data">
            ...
            <div id="listEducationCandidate">
                @if(!empty(Session::get('session_candidate')))
                    ...
                    <div class="listStudy">
                        ...
                        <input type="hidden" name="tipeInput" id="tipeInput" value="update">
                        @if($i > 0)
                        <hr>
                        @endif
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-11 col-md-12">
                                            ...
                                            <input type="hidden" name="oldCertificate" value="{{Session::get('session_candidate')['pendidikan'][$i]['ijazah']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            @if($i > 0)
                            <div class="col-lg-6 col-md-12 removeThisEducation" id="removeThisEducation{{Session::get('session_candidate')['pendidikan'][$i]['id']}}">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-11 col-md-12">
                                            <button type="button" class="btn btn-white btn-block removeThisEducationVal" value="{{ Session::get('session_candidate')['pendidikan'][$i]['id'] }}">
                            ...
                            @endif
                            @if($i > 1 && count(Session::get('session_candidate')['pendidikan'])-1 == $i)
            ...
            <div class="row mb-4 margin-right-2rem firstBtnListEducation">
                <div class="col-lg-12 col-md-12 firstBtnEducation">
                    <button type="button" class="btn btn-white btn-block large btnAddListEducation" id="btnAddListEducation">
