...
var form = {
	...
	$('.select-provinsi').append('<label class="form-label">Provinsi</label>' + '<div class="input-form-select">' + '<select name="provinsi" id="provinsi" class="form-control select2 input-form-select">' + '<option></option>' + '</select>' + '</div>');

	$('.select-kota').empty();
	$('.select-kota').append('<label class="form-label">Kota/Kabupaten</label>' + '<div class="input-form-select">' + '<select name="kota" id="kota" class="form-control select2 input-form-select">' + '<option></option>' + '</select>' + '</div>');

	_ajax.getData('wilayah/search-provinsi', 'post', null, function (data) {
		var dataProvinsi = [];
		...
		$('#provinsi').change(function () {
			...
			_ajax.getData('wilayah/search-kota', 'post', { provinsi: provinsi }, function (data) {
				var dataKota = [];
...
if ($('.select-provinsi-edit').length) {
	$('#provinsiEdit').change(function () {
		...
		_ajax.getData('wilayah/search-kota', 'post', { provinsi: provinsi }, function (data) {
			...
			$('.select-kota-edit').append('<label>Kota/Kabupaten</label>' + '<select name="kotaEdit" id="kotaEdit" class="form-control upgrade-input">' + '<option></option>' + '</select>');
