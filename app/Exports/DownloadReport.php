...
class DownloadReport implements FromView, ShouldAutoSize{
    ...
    public function view(): View
    {
        ...
        if ($tipe == "1") {
            ...
            return view('admin.report.report-download', ['downloadData' => $dataReport, 'tipe'=>$tipe]);
